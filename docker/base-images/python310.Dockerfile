# RemoteMedia Python 3.10 Node - Single Stage Build
#
# Uses pytorch/pytorch base image with CUDA support
# Includes: Python 3.10, PyTorch, RemoteMedia SDK, iceoryx2 IPC, CUDA libraries
#
# Build:
#   docker build -f docker/base-images/python310.Dockerfile -t remotemedia/python310-node:latest .
#
# Test:
#   docker run --rm remotemedia/python310-node:latest python -c "import torch, remotemedia, iceoryx2; print('All OK')"

ARG PYTORCH_VERSION=2.0.1

# Use PyTorch base image with Python 3.10
FROM pytorch/pytorch:${PYTORCH_VERSION}-cuda11.7-cudnn8-runtime
