# RemoteMedia Python 3.11 Node - Single Stage Build
#
# Uses pytorch/pytorch base image with CUDA support
# Includes: Python 3.11, PyTorch, RemoteMedia SDK, iceoryx2 IPC, CUDA libraries
#
# Build:
#   docker build -f docker/base-images/python311.Dockerfile -t remotemedia/python311-node:latest .
#
# Test:
#   docker run --rm remotemedia/python311-node:latest python -c "import torch, remotemedia, iceoryx2; print('All OK')"

ARG PYTORCH_VERSION=2.5.1

# Use PyTorch base image with Python 3.11 (same as Dockerfile.pytorch-node)
