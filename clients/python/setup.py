...
setup(
    ...
    python_requires=">=3.9",
    install_requires=[
        # Note: "remotemedia" package is installed from repo root (pip install -e .)
        "grpcio>=1.50.0",
        "grpcio-tools>=1.50.0",
        "protobuf>=4.21.0",
        "numpy>=1.21.0,<2.0",
        ...
        # the Rust server. Not optional — every venv provisioned by the
        # managed-env system runs this runner, so iceoryx2 must be present.
        "iceoryx2>=0.5",
    ],
    extras_require={
