...
//!
//! ```ignore
//! use remotemedia_runtime_core::transport::client::grpc::GrpcPipelineClient;
//!
...
impl PipelineClient for GrpcPipelineClient {
    ...
    async fn execute_unary(
        ...
        // This requires protobuf conversion utilities which should be in remotemedia-grpc
        Err(Error::Transport(
            "gRPC execute_unary not yet fully implemented - requires protobuf conversion utilities from remotemedia-grpc".to_string(),
        ))
    }
    ...
    async fn create_stream_session(
        ...
        Err(Error::Transport(
            "gRPC create_stream_session not yet fully implemented - requires protobuf conversion utilities from remotemedia-grpc".to_string(),
        ))
    }
...
impl ClientStreamSession for GrpcStreamSession {
    ...
    async fn send(&mut self, _data: TransportData) -> Result<()> {
        ...
        // TODO: Implement actual streaming send
        Err(Error::Transport(
    ...
    async fn receive(&mut self) -> Result<Option<TransportData>> {
        ...
        // TODO: Implement actual streaming receive
        Err(Error::Transport(
