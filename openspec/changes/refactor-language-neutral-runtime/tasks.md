...
### 1.1 Project Setup
- [ ] 1.1.1 Create Rust workspace in `runtime/` directory
- [ ] 1.1.2 Add dependencies: tokio, serde, RustPython, wasmtime
- [ ] 1.1.3 Set up CI/CD for Rust builds (GitHub Actions)
...
- [ ] 1.4.1 Choose FFI approach (PyO3, CFFI, or custom bindings)
- [ ] 1.4.2 Implement `Pipeline.run()` FFI wrapper in Python
- [ ] 1.4.3 Create Rust extern "C" functions for FFI entry points
