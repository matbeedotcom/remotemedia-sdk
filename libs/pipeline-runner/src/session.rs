...
use remotemedia_runtime_core::transport::{PipelineExecutor, SessionHandle, TransportData};
use thiserror::Error;
...
///
/// Wraps the runtime-core's session handling to provide a clean interface
...
mod tests {
    use super::*;
    use remotemedia_runtime_core::manifest::{ManifestMetadata, NodeManifest};
