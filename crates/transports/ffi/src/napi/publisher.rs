...
//! # Architecture
//!
//! This module integrates with the core ChannelRegistry to ensure
...
use remotemedia_core::python::multiprocess::ipc_channel::ChannelRegistry;
    ...
    match data {
        ...
        RuntimeData::Video {
            ...
            let format_byte = match format {
                remotemedia_core::data::video::PixelFormat::Unspecified => 0,
                remotemedia_core::data::video::PixelFormat::Yuv420p => 1,
                remotemedia_core::data::video::PixelFormat::I420 => 2,
                remotemedia_core::data::video::PixelFormat::NV12 => 3,
                remotemedia_core::data::video::PixelFormat::Rgb24 => 4,
                remotemedia_core::data::video::PixelFormat::Rgba32 => 5,
                remotemedia_core::data::video::PixelFormat::Encoded => 255,
            };
            let codec_byte = match codec {
                None => 0,
                Some(remotemedia_core::data::video::VideoCodec::Vp8) => 1,
                Some(remotemedia_core::data::video::VideoCodec::H264) => 2,
                Some(remotemedia_core::data::video::VideoCodec::Av1) => 3,
            };
