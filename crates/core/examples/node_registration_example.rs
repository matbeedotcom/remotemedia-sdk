...
use remotemedia_core::nodes::registry::{NodeRegistry, RuntimeHint};
use remotemedia_core::registration_macros::{
...
impl AudioChunkerNode {
    fn new(chunk_size: usize) -> remotemedia_core::Result<Self> {
        Ok(Self { chunk_size })
    }
}
