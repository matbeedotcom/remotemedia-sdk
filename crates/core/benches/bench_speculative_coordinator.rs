...
//! - Speedup ratio
//!
//! Run with: cargo bench -p remotemedia-core --bench bench_speculative_coordinator --features silero-vad
...
use remotemedia_core::nodes::{AsyncStreamingNode, SileroVADNode};
