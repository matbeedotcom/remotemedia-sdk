...
use remotemedia_core::transport::client::PipelineClient;
use remotemedia_core::transport::executor::PipelineExecutor;
...
fn test_register_duplicate_plugin_names() {
    ...
    match result2 {
        Err(remotemedia_core::Error::ConfigError(msg)) => {
            assert!(
