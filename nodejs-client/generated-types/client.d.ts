...
export interface RemoteExecutionClient {
     ...
     */
    executeNode<T extends NodeType>(nodeType: T, config: Partial<NodeMap[T]>, inputData: any, options?: ExecutionOptions): Promise<ExecutionResponse>;
    /**
     ...
     */
    streamNode<T extends NodeType>(nodeType: T, config: Partial<NodeMap[T]>, onData: (data: any) => void, onError?: (error: Error) => void): StreamHandle;
    /**
